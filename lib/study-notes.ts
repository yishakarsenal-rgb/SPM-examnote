    ...
    keyTerms: [
      {
        term: "Project",
        definition:
          "A temporary, unique endeavor undertaken to create a specific product, service, or result with a defined beginning and end.",
      },
      {
        term: "Program",
        definition:
          "A set of related projects aimed at a broader strategic goal, typically longer-lasting and may not have a fixed end date.",
      },
      {
      ...
      },
      {
        ...
        definition:
          "The three key interrelated variables of project management: Time, Cost, and Quality.",
      },
      {
        term: "Internal Project",
        definition:
          "A project done to improve organizational operations with an internal sponsor.",
      },
      {
        term: "External Project",
        definition:
          "A project done for an outside client, usually under contract, generating revenue.",
      },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        highlight:
          "The internal system also has the advantage that specialist knowledge can easily be built up and shared within the function.",
      },
      {
    ...
    keyTerms: [
      {
        ...
        definition:
          "A formal document that authorizes the existence of a project and provides the PM with authority to apply organizational resources.",
      },
      {
        term: "NPV",
        definition:
          "Net Present Value — the total present value of a time series of cash flows. Higher NPV is better; accept if NPV > 0.",
      },
      {
        term: "IRR",
        definition:
          "Internal Rate of Return — the discount rate when NPV equals zero. Measures how fast money returns after investment.",
      },
      {
        term: "ROI",
        definition:
          "Return on Investment = (Total Discounted Benefits - Total Discounted Costs) / Discounted Costs. Higher ROI is better.",
      },
      {
        term: "Payback Period",
        definition:
          "The time it takes to recover the initial investment before starting to accumulate profit.",
      },
      {
        term: "SWOT Analysis",
        definition:
          "Strengths, Weaknesses, Opportunities, Threats — a strategic planning tool to identify and select valuable projects.",
      },
      {
        term: "Sunk Cost",
        definition:
          "Money that has already been spent. Should NOT be included in future project budgets or investment decisions.",
      },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        highlight:
          "NPV Decision Rule: If NPV > 0 → ACCEPT | If NPV < 0 → REJECT | If NPV = 0 → INDIFFERENT",
      },
      {
    ...
    keyTerms: [
      {
        term: "Scope",
        definition:
          "The description of the boundaries of the project — what it will deliver and what it will not deliver.",
      },
      {
        term: "Scope Creep",
        definition:
          "Uncontrolled changes in a project's scope — the tendency to include more tasks than originally specified, leading to higher costs and extended timelines.",
      },
      {
        term: "WBS",
        definition:
          "Work Breakdown Structure — a hierarchical, outcome-oriented analysis of all work involved in the project that defines total scope.",
      },
      {
        term: "Work Package",
        definition:
          "The lowest level of the WBS — a deliverable. By the 80/8 rule: not longer than 80 hours, not smaller than 8 hours.",
      },
      {
        term: "100% Rule",
        definition:
      ...
      },
      {
        ...
        definition:
          "A document used to develop and confirm a common understanding of project scope among stakeholders. The most important tool to frame the project.",
      },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        highlight:
          "The Project Scope Statement is the most important tool the project has to frame the project — it evaluates every change request and communicates project limits.",
      },
      {
    ...
    keyTerms: [
      {
        term: "Critical Path",
        definition:
          "The longest path through the network diagram — determines the minimum project duration. Activities on this path have zero float.",
      },
      {
        term: "Float / Slack",
        definition:
          "The amount of time an activity can be delayed without delaying the project. Critical path activities have 0 float.",
      },
      {
        term: "PERT",
        definition:
          "Program Evaluation and Review Technique. Formula: (O + 4M + P) / 6 where O=Optimistic, M=Most Likely, P=Pessimistic.",
      },
      {
        term: "ES",
        definition: "Early Start — the earliest time an activity can begin.",
      },
      {
        term: "EF",
        definition:
          "Early Finish — EF = ES + Duration - 1 (using Day 0 convention).",
      },
      {
        term: "LS",
        definition:
          "Late Start — the latest time an activity can begin without delaying the project. LS = LF - Duration + 1.",
      },
      {
        term: "LF",
        definition:
          "Late Finish — the latest time an activity can end without delaying the project.",
      },
      {
        term: "Total Float",
        definition:
          "Total Float = LS - ES = LF - EF. Zero float means the activity is on the critical path.",
      },
      {
        term: "Mandatory Dependency",
        definition:
          "An inherent dependency in the nature of the work (hard logic). E.g., code must be written before it can be tested.",
      },
      {
        term: "Discretionary Dependency",
        definition:
          "A dependency defined by the project team (soft logic). May limit later scheduling options.",
      },
    ],
    sections: [
      {
        ...
        calculations: [
          {
            ...
            example:
              "For a coding task: Optimistic = 2 days, Most Likely = 5 days, Pessimistic = 8 days. TE = (2 + 4×5 + 8) / 6 = (2 + 20 + 8) / 6 = 30 / 6 = 5 days",
            result: "5 days",
          },
          {
            formula: "PERT Variance: σ² = ((P - O) / 6)²",
            example:
              "Pessimistic = 8, Optimistic = 2. σ² = ((8 - 2) / 6)² = (6 / 6)² = 1² = 1",
            result: "1 (variance)",
          },
          {
            formula: "PERT Standard Deviation: σ = (P - O) / 6",
            example:
              "Pessimistic = 8, Optimistic = 2. σ = (8 - 2) / 6 = 6 / 6 = 1 day",
            result: "1 day",
          },
        ],
      },
      ...
      },
      {
        ...
        highlight:
          "Critical Path = The longest total duration path through the network. It is the shortest possible project completion time.",
        calculations: [
          {
            formula: "EF = ES + Duration - 1",
            example:
              "Activity starts on Day 2 (ES=2), Duration = 5 days. EF = 2 + 5 - 1 = 6 (activity ends on Day 6)",
            result: "Day 6",
          },
          {
            formula: "LS = LF - Duration + 1",
            example:
              "Latest Finish is Day 10, Duration = 5 days. LS = 10 - 5 + 1 = 6 (must start by Day 6)",
            result: "Day 6",
          },
          {
            formula: "Total Float = LS - ES",
            example:
              "Late Start = Day 8, Early Start = Day 5. Total Float = 8 - 5 = 3 days (can be delayed 3 days)",
            result: "3 days",
          },
          {
            formula: "Total Float = LF - EF",
            example:
              "Late Finish = Day 12, Early Finish = Day 9. Total Float = 12 - 9 = 3 days (same result)",
            result: "3 days",
          },
          {
            formula: "Free Float = MIN(Successor ES) - EF - 1",
            example:
              "Activity EF = Day 6. Next activity (Successor) ES = Day 8. Free Float = 8 - 6 - 1 = 1 day",
            result: "1 day",
          },
          {
            formula: "Critical Path Duration",
            example:
              "Path A: 5 + 6 + 7 = 18 days. Path B: 8 + 4 + 5 = 17 days. Critical Path = Path A = 18 days (longest path)",
    ...
    keyTerms: [
      {
        term: "ROM Estimate",
        definition:
          "Rough Order of Magnitude — accuracy of -50% to +100%. Done very early in a project (3+ years before completion).",
      },
      {
        term: "Budgetary Estimate",
        definition:
          "Accuracy of -10% to +25%. Made 1-2 years before project completion for budget allocation.",
      },
      {
        term: "Definitive Estimate",
        definition:
          "Most accurate estimate — accuracy of -5% to +10%. Made within 1 year of completion.",
      },
      {
        term: "EVM",
        definition:
      ...
      },
      {
        term: "PV",
        definition:
          "Planned Value — the authorized budget assigned to scheduled work. Also called BCWS (Budgeted Cost of Work Scheduled).",
      },
      {
        term: "EV",
        definition:
          "Earned Value — the value of work actually performed. EV = % Complete × BAC. Also called BCWP.",
      },
      {
        term: "AC",
        definition:
          "Actual Cost — the actual cost incurred for work performed. Also called ACWP.",
      },
      {
        term: "CV",
        definition:
      ...
      },
      {
        term: "CPI",
        definition:
          "Cost Performance Index = EV / AC. CPI > 1 = Under budget (good). CPI < 1 = Over budget (bad).",
      },
      {
        term: "SPI",
        definition:
          "Schedule Performance Index = EV / PV. SPI > 1 = Ahead of schedule (good). SPI < 1 = Behind schedule (bad).",
      },
      {
        term: "EAC",
        definition:
          "Estimate at Completion. EAC = BAC / CPI (most common). The forecasted total project cost.",
      },
      {
        term: "ETC",
        definition:
          "Estimate to Complete = EAC - AC. How much more money is needed to finish the project.",
      },
      {
        term: "TCPI",
        definition:
          "To-Complete Performance Index = (BAC - EV) / (BAC - AC). The required CPI to finish within budget.",
      },
      {
        term: "BAC",
        definition:
          "Budget at Completion — the total approved budget for the project.",
      },
      {
        term: "VAC",
        definition:
          "Variance at Completion = BAC - EAC. Projected budget surplus or deficit at completion.",
      },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        highlight:
          "EVM Key: EV is always in the middle. CV compares EV to cost (AC). SV compares EV to plan (PV).",
        calculations: [
          {
            formula: "PV = % Planned × BAC",
            example:
              "Project BAC = $100,000. At Week 4, you planned to be 40% complete. PV = 0.40 × $100,000 = $40,000",
            result: "$40,000",
          },
          {
            formula: "EV = % Complete × BAC",
            example:
              "Project BAC = $100,000. At Week 4, you are actually 35% complete. EV = 0.35 × $100,000 = $35,000",
            result: "$35,000",
          },
          {
            formula: "CV = EV - AC",
            example:
              "EV = $35,000, AC = $37,000. CV = $35,000 - $37,000 = -$2,000 (OVER budget by $2,000)",
            result: "-$2,000",
          },
          {
            formula: "SV = EV - PV",
            example:
              "EV = $35,000, PV = $40,000. SV = $35,000 - $40,000 = -$5,000 (BEHIND schedule)",
            result: "-$5,000",
          },
          {
            formula: "CPI = EV / AC",
            example:
              "EV = $35,000, AC = $37,000. CPI = $35,000 / $37,000 = 0.946 (spent $1.06 for every $1.00 earned)",
            result: "0.946 (BAD)",
          },
          {
            formula: "EAC = BAC / CPI",
            example:
              "BAC = $100,000, CPI = 0.946. EAC = $100,000 / 0.946 = $105,710 (project will cost $5,710 MORE)",
            result: "$105,710",
          },
          {
            formula: "ETC = EAC - AC",
            example:
              "EAC = $105,710, AC = $37,000. ETC = $105,710 - $37,000 = $68,710 (need $68,710 more to finish)",
            result: "$68,710",
          },
          {
            formula: "TCPI = (BAC - EV) / (BAC - AC)",
            example:
              "BAC = $100,000, EV = $35,000, AC = $37,000. TCPI = ($100,000 - $35,000) / ($100,000 - $37,000) = $65,000 / $63,000 = 1.032 (need to improve efficiency)",
            result: "1.032",
          },
          {
            formula: "VAC = BAC - EAC",
            example:
              "BAC = $100,000, EAC = $105,710. VAC = $100,000 - $105,710 = -$5,710 (projected budget deficit)",
            result: "-$5,710",
          },
        ],
      },
    ...
    keyTerms: [
      {
        ...
        definition:
          "5-level need hierarchy: Physiological → Safety → Social → Esteem → Self-Actualization. Must satisfy lower needs before higher ones motivate.",
      },
      {
        term: "Theory X",
        definition:
          "McGregor: Workers hate work, need coercion and control. Managers must use pressure and threats.",
      },
      {
        term: "Theory Y",
        definition:
          "McGregor: Workers can work without supervision, want to achieve, enjoy esteem and self-actualization.",
      },
      {
        term: "Theory Z",
        definition:
          "Ouchi: Based on Japanese participative management. Workers motivated by commitment, opportunity, and advancement.",
      },
      {
        term: "Herzberg Hygiene Factors",
        definition:
          "Prevent dissatisfaction but don't cause satisfaction: salary, working conditions, job security, supervision, company policies.",
      },
      {
        term: "Herzberg Motivators",
        definition:
          "Produce job satisfaction: achievement, recognition, the work itself, responsibility, advancement, growth.",
      },
      {
        term: "Vroom Expectancy Theory",
        definition:
          "Motivation = Expectancy × Instrumentality × Valence. People act if they expect good rewards.",
      },
      {
        term: "McClelland's Achievement Theory",
        definition:
          "People motivated by three needs: Achievement (nAch), Power (nPow), Affiliation (nAff). These are learned, not innate.",
      },
      {
        term: "Tuckman's Team Stages",
        definition:
          "Forming → Storming → Norming → Performing → Adjourning. Five stages of team development.",
      },
      {
        term: "Halo Effect",
        definition:
          "Assuming excellence in one area (e.g., programming) means excellence in another (e.g., project management).",
      },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        highlight:
          "Herzberg: Salary is a hygiene factor (prevents dissatisfaction), NOT a motivator. Achievement and recognition ARE motivators.",
      },
      {
    ...
    keyTerms: [
      {
        term: "Risk",
        definition:
          "The possibility of potential harm from a present process or future event. Also associated with the probability of the event occurring.",
      },
      {
        term: "Internal Risk",
        definition:
          "Comes from the project organization — limited support, lack of qualified resources, poor management competencies.",
      },
      {
        term: "External Risk",
        definition:
          "Comes from the environment — political system, socioeconomic context, geography, infrastructure. More difficult to manage.",
      },
      {
        term: "Risk Index",
        definition:
          "Risk Priority = Probability × Impact. Used to rank risks from highest to lowest for response planning.",
      },
      {
        term: "Contingency Plan",
        definition:
          "Predefined actions the project team will take if one of the identified risks occurs.",
      },
      {
        term: "Fallback Plan",
        definition:
          "Plans for high-impact risks, used when activities to reduce/mitigate the risk have not worked.",
      },
      {
        term: "Contingency Budget Reserve",
        definition:
          "A financial provision held by the project or organization to mitigate costs caused by a risk event.",
      },
      {
        term: "Risk Avoidance",
        definition:
          "Making changes to the project to completely remove the risk.",
      },
      {
        term: "Risk Mitigation",
        definition:
          "Taking action to reduce the impact or probability of the risk occurring.",
      },
      {
        term: "Risk Transfer",
        definition:
          "Moving the liability of the risk to a third party (e.g., insurance, outsourcing).",
      },
      {
        term: "Risk Acceptance",
        definition:
          "Accepting the consequences of the risk. Used when risk is small or no response strategy is feasible.",
      },
      {
        term: "SWOT for Risk",
        definition:
          "Strengths, Weaknesses, Opportunities, Threats analysis used to identify potential project risks.",
      },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        highlight:
          "Risk Priority Table: Index 9 → Avoid | Index 6-4 → Mitigate/Transfer (1st) | Index 3-2 → Mitigate/Transfer (2nd) | Index 1 → Accept & Monitor",
      },
      {
    ...
    keyTerms: [
      {
        term: "Quality",
        definition:
          '"The totality of characteristics of an entity that bear on its ability to satisfy stated or implied needs." Conformance to requirements OR fitness for use.',
      },
      {
        term: "Quality vs. Grade",
        definition:
          "Quality = absence of defects. Grade = additional features. A product can be high quality (no defects) but low grade (few features).",
      },
      {
        term: "PDCA Cycle",
        definition:
          "Plan-Do-Check-Act (Shewhart/Deming Cycle) — the most popular quality assurance tool for continuous improvement.",
      },
      {
        term: "Quality Definition",
        definition:
          "Identifying quality standards from donors, beneficiaries, organization, and external agencies.",
      },
      {
        term: "Quality Assurance",
        definition:
          "Providing evidence to create confidence that quality-related activities are being performed effectively. Proactive.",
      },
      {
        term: "Quality Control",
        definition:
          "Monitoring and verifying that outputs meet quality standards. Reactive — identifies defects in products/services.",
      },
      {
        term: "Quality Audit",
        definition:
          "Structured review of quality management activities to identify lessons learned and improve performance.",
      },
      {
        term: "Sphere Standard",
        definition:
          "Worldwide recognized standard for emergency projects — defines minimum standards for water, sanitation, health, shelter, food security, nutrition.",
      },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        highlight:
          "The PDCA Cycle is never-ending — it repeats throughout the project lifetime to continuously improve internal efficiency and quality.",
      },
      {
